...
const Consult = () => {
    ...
    const healthConcerns = [
        ...
        { title: 'Headaches', description: 'Expert diagnosis and treatment', image: '/api/placeholder/300/200' },
        { title: 'Stomach Issues', description: 'Digestive health consultation', image: '/api/placeholder/300/200' },
        { title: 'Skin Problems', description: 'Dermatology consultations', image: '/api/placeholder/300/200' }
    ];
    ...
    const testimonials = [
        {
            name: 'Alice Johnson',
            review: 'Amazing experience! The doctor was very professional and helped me understand my condition clearly.',
            rating: 5,
            condition: 'Migraine Treatment'
        },
        {
            name: 'Robert Smith',
            review: 'Quick and convenient consultation. Saved me a trip to the hospital during busy schedule.',
            rating: 5,
            condition: 'Cold & Flu'
        },
        {
            name: 'Maria Garcia',
            review: 'Excellent service for my child. The pediatrician was patient and caring throughout the consultation.',
            rating: 5,
    ...
    const faqs = [
        {
            ...
            answer: 'Simply select your specialty, choose a doctor, pick a time slot and complete the booking process.'
        },
        {
            question: 'Is online consultation safe?',
            answer: 'Yes, all consultations are conducted through secure, encrypted platforms ensuring complete privacy.'
        },
        {
            question: 'What if I need a prescription?',
            answer: 'Doctors can provide digital prescriptions which you can use at any pharmacy or for medicine delivery.'
        },
        {
            question: 'How much does a consultation cost?',
            answer: 'Consultation fees vary by specialty and doctor experience, typically ranging from $25-75.'
        }
    ];
            ...
            <section className="hero-section1">
                <div className="hero-content">
                    <div className="hero-text">
                        ...
                        <p>Connect instantly with a 24x7 specialist or choose to video consult later.</p>
                    ...
                    <div className="hero-image">
                        <img src="https://www.practo.com/consult/static/images/homepage-hero-image-web-v1.png" alt="Doctor consultation" />
                    </div>
                </div>
            </section>
                ...
                <div className="offers-grid">
                    <div className="offer-card primary">
                        ...
                        <div className="offer-image">
                            <img height={'150px'} src="https://www.practo.com/consult/static/images/offer-app-v1.png" alt="App download offer" />
                        </div>
                    </div>
                    <div className="offer-card secondary">
                        ...
                        <div className="offer-doctor">
                            <img height={'150px'} src="https://www.practo.com/consult/static/images/offer-specialist-v1.png" alt="Doctor" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="app-download-section">
                <div className="app-content">
                    ...
                    <div className="app-mockup">
                        <img src="https://www.practo.com/consult/static/images/app-download-banner-web.png" alt="Practo app mockup" />
                    </div>
                </div>
            </section>
        </div>
